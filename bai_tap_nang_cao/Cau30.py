"""Viết chương trình tính tổng của các số Carmichael (là các số giả nguyên tố n thoả mãn điều kiện là hợp số và thoả
mãn b^(n-1)≡1 (mod n) với mọi số nguyên dương b nguyên tố cùng nhau với n) nhỏ hơn một số N cho trước nhập vào từ bàn
...
if __name__ == '__main__':
    ...
    for i in range(2, num + 1):  # 0 và 1 không phải số Carmichael vì 0 và 1 không phải số nt cũng kp hợp số
        if is_carmi(i):
            cout += i
    print(f"Tổng các số Carmichael nhỏ hơn {num} là {cout}")
